...
<div class="modal fade" id="deleteModal<?php echo $cID; ?>" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <form method="POST" action="collection.php">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="submit_deleteCollection" class="btn btn-danger">
