...
<div class="modal fade" id="deleteModal<?php echo $timeID; ?>" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <form method="POST" action="time.php">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="submit_deleteTime" class="btn btn-danger">
