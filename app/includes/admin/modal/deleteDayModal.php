...
<div class="modal fade" id="deleteModal<?php echo $dayID; ?>" tabindex="-1" aria-labelledby="deleteModalLabel" aria-hidden="true">
        ...
        <div class="modal-content">
            <form method="POST" action="day.php">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" name="submit_deleteDay" class="btn btn-danger">
